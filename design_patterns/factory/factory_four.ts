...
class VehicleNewSuperX01 extends VehicleNew {
    public run(): void {
        console.debug("VehicleSuperX01 init");
    }
}

class VehicleNewSuperX02 extends VehicleNew {
    public run(): void {
        console.debug("VehicleSuperX02 init");
    }
}
...
abstract class VehicleNewFactory {
    public abstract produceVehicle(): VehicleNew
}
...
class VehicleNewSuperX01Factory extends VehicleNewFactory {
    public produceVehicle(): VehicleNew {
        console.debug("Vehicle New SuperX01 start to produce vehicle");
...
class VehicleNewSuperX02Factory extends VehicleNewFactory {
    public produceVehicle(): VehicleNew {
        console.debug("Vehicle New SuperX02 start to produce vehicle");
...
const vehicleNewSuperX01: VehicleNew = vehicleNewSuperX01Factory.produceVehicle();
const vehicleNewSuperX02: VehicleNew = vehicleNewSuperX02Factory.produceVehicle();
